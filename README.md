...
- `assets/branding/`: key art, wide/vertical/square capsule art, IndieX-ready preview art, and branding guide
- `Mancalero_Applications_Record.md`: confirmed showcase applications/registrations and clearly separated preparation status

The supplied capsule art, logos, screenshots, GIFs, gameplay clips, official YouTube trailer, IndieX-ready art exports, press-kit ZIP, and creator B-roll ZIP are included. Three.js is loaded from a pinned public module URL so the site remains a no-build GitHub Pages deployment. The public press contact is `needle-blares.0m@icloud.com`.
